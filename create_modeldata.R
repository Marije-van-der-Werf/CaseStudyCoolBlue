...
rm(sales_perday, Display_per_combi, Social_per_combi, priceDummies, CompetitorNA, CompetitorExtrapolated, ExtrapolerenNoRetailer, ExtrapolerenRetailer, CompletedDataNoRetailer, CompletedDataRetailer, SpillOver, SpillOverOther, SpillOverSocial, SpillOverDisplay)
